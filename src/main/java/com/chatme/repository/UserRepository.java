...
public interface UserRepository extends CrudRepository<User, Long>
{
	...
	List<User> findTop25ByUsernameContainingOrEmailContainingAndUsernameNotInOrderByUsername(String username, String email, Collection<String> currendAndFriends);
}
